...
function calculateBanner(banner){
  ...
  //Get selected data  
  var banner_price = "<?php return htmlspecialchars($xml->banner, ENT_QUOTES); ?>"
...
function calculateFoamcore(foamcore){
  ...
  //Get selected data  
  var foamcore_price = "<?php return htmlspecialchars($xml->foamcore, ENT_QUOTES); ?>"
...
function calculateCoroplast(coroplast){
  ...
  //Get selected data  
  var coroplast_price = "<?php return htmlspecialchars($xml->coroplast, ENT_QUOTES); ?>"
...
function calculateGator(gator){
  ...
  //Get selected data  
  var gator_price = "<?php return htmlspecialchars($xml->gatorboard, ENT_QUOTES); ?>"
...
function calculateSatin(satin){
  ...
  //Get selected data  
  var satin_price = "<?php return htmlspecialchars($xml->satin, ENT_QUOTES); ?>"
...
function calculatePullup(pullup){
  ...
  //Get selected data  
  var paper_price = "<?php return htmlspecialchars($xml->banner, ENT_QUOTES); ?>"
